...
#define HID_MAX_APPS (GAMEPAD_COUNT)

// Number of HID reports defined in the service
#define HID_NUM_REPORTS (GAMEPAD_COUNT + 1)

// HID Report IDs for the service
#define HID_RPT_ID_FEATURE 0	    // Feature report ID
#define HID_RPT_ID_GAMEPAD0_IN 1  // Gamepad input report ID
#define HID_RPT_ID_GAMEPAD1_IN 2
#define HID_RPT_ID_GAMEPAD2_IN 3
#define HID_RPT_ID_GAMEPAD3_IN 4

#define ATT_SVC_HID 0x1812

#define HIDD_APP_ID ATT_SVC_HID
#define BATTRAY_APP_ID 0x180f

/// Maximal number of Report Char. that can be added in the DB for one HIDS - Up to 11
#define HIDD_LE_NB_REPORT_INST_MAX (GAMEPAD_COUNT + 2)
...
enum {
	...
	HIDD_LE_IDX_REPORT_GAMEPAD0_IN_CHAR,
	HIDD_LE_IDX_REPORT_GAMEPAD0_IN_VAL,
	HIDD_LE_IDX_REPORT_GAMEPAD0_IN_CCC,
	HIDD_LE_IDX_REPORT_GAMEPAD0_REP_REF,

#if GAMEPAD_COUNT > 1
	HIDD_LE_IDX_REPORT_GAMEPAD1_IN_CHAR,
	HIDD_LE_IDX_REPORT_GAMEPAD1_IN_VAL,
	HIDD_LE_IDX_REPORT_GAMEPAD1_IN_CCC,
	HIDD_LE_IDX_REPORT_GAMEPAD1_REP_REF,
#if GAMEPAD_COUNT > 2
...
#if GAMEPAD_COUNT > 3
	HIDD_LE_IDX_REPORT_GAMEPAD3_IN_CHAR,
	HIDD_LE_IDX_REPORT_GAMEPAD3_IN_VAL,
	HIDD_LE_IDX_REPORT_GAMEPAD3_IN_CCC,
	HIDD_LE_IDX_REPORT_GAMEPAD3_REP_REF,
#endif
#endif
#endif
